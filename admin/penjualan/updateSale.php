...
<form class="form row g-3 p-4 needs-validation" action="" method="POST" novalidate enctype="multipart/form-data">
    <div class="col-md-6">
        ...
        <select id="id_properti" name="id_properti" class="form-select" required>
            <option selected disabled><?php echo $resultShow['id_properti'] ?></option>
            <?php
    ...
    <div class="col-md-6">
        ...
        <select id="id_agen" name="id_agen" class="form-select" required>
            <option selected disabled><?php echo $resultShow['id_agen'] ?></option>
            <?php
    ...
    <div class="col-md-6">
        ...
        <input type="text" value="<?php echo $resultShow['nama'] ?>" class=" form-control" id="nama" name="nama" required placeholder="name pembeli" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-12">
        ...
        <input type="text" value="<?php echo $resultShow['alamat'] ?>" class="form-control" id="alamat" name="alamat" required placeholder="addres" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="number" value="<?php echo $resultShow['no_telp'] ?>" class="form-control" id="no_telp" name="no_telp" required placeholder="nomor telepon" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="email" value="<?php echo $resultShow['email'] ?>" class="form-control" id="email" name="email" required placeholder="province" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="date" value="<?php echo $resultShow['tgl_pesan'] ?>" class="form-control" id="tanggal_pesan" name="tanggal_pesan" required placeholder="Luas bangunan" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="date" value="<?php echo $resultShow['tgl_selesai'] ?>" class="form-control" id="tanggal_selesai" name="tanggal_selesai" required placeholder="Luas bangunan" />
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="number" value="<?php echo $resultShow['jumlah_dp'] ?>" class="form-control" id="jumlah_dp" name="jumlah_dp" required placeholder="Dp" />
        <div class="valid-feedback">Looks good!</div>
