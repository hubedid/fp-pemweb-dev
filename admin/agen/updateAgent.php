...
<div
  ...
  <!-- Form -->
  <form
    class="form p-4 needs-validation"
    action=""
    method="POST"
    novalidate
  ...
  >
    <div class="mb-3">
      ...
      <input
        ...
        name="nama"
        placeholder="name"
        value="<?php echo $resultShow['nama']; ?>"
        required
      />
    ...
    <div class="mb-3">
      ...
      <input
        ...
        name="email"
        placeholder="email"
        value="<?php echo $resultShow['email']; ?>"
        required
      />
      <div class="valid-feedback">Looks good!</div>
    ...
    <div class="mb-3">
      ...
      <input
        ...
        name="umur"
        placeholder="age"
        value="<?php echo $resultShow['umur']; ?>"
        required
      />
      <div class="valid-feedback">Looks good!</div>
    ...
    <div class="mb-3">
      ...
      <input
        ...
        value="<?php echo $resultShow['no_telp']; ?>"
        required
      />
      <div class="valid-feedback">Looks good!</div>
