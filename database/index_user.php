          ...
          <div class="header-content">
            ...
            <form class="search-form" method="" action="">
              <input
                class="form-input"
                type="text"
                placeholder="Masukkan yang anda cari"
              />
        ...
        <div class="card-box">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <a href="detail.php?id=<?php echo $row['id']; ?>">
                    <div class="card">
                        <div class="property-content-1" style="background-image: url('<?php echo $gambar; ?>'); background-size: cover; background-position: center;">
                        ...
                        <div class="property-content-3">
                            <div class="detail-box">
                                <h5><?php echo $kamar_tidur; ?></h5>
                                <h6>Bedroom</h6>
                            </div>
                            <div class="detail-box">
                                <h5><?php echo $kamar_mandi; ?></h5>
                                <h6>Bathroom</h6>
                            </div>
                            <div class="detail-box">
                                <h5><?php echo $balcony; ?></h5>
                                <h6>Balcony</h6>
                            </div>
                            <div class="detail-box">
                                <h5><?php echo $hall; ?></h5>
